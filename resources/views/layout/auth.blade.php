        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url({{ image('misc/auth-bg.png') }})">
                ...
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    <!--begin::Logo-->
                    <a href="{{ route('dashboard') }}" class="mb-5 justify-content-center d-flex flex-column">
                        <img alt="Logo" src="{{ image('logos/kode_visual_white.svg') }}" class="h-60px h-lg-75px"/>
                        <div class="text-white fs-2qx fw-bolder text-center mb-7">KODE VISUAL</div>
                    </a>
                    <!--end::Logo-->
