            ...
            <div class="card card-flush h-md-100 shadow-sm border-0 bg-gradient-primary text-white" style="background: linear-gradient(135deg, #f7931a 0%, #ffab40 100%);">
                <div class="card-header pt-5">
                    <div class="card-title d-flex flex-column">
                        ...
                        <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Total Crypto Portfolio Value</span>
                    </div>
                </div>
                <div class="card-body d-flex align-items-end pt-0">
                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                        <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                            <span class="fw-boldest fs-6 text-white">{{ $btcPortfolios->count() }} Broker Accounts Registered</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-flush h-md-100 shadow-sm border-0">
                <div class="card-header pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold text-gray-800">My Crypto Assets</span>
                        <span class="text-gray-400 mt-1 fw-semibold fs-7">Balance breakdown per asset</span>
                    </h3>
                </div>
                <div class="card-body pt-2">
                    <div class="row">
                        @forelse($assetBalances as $item)
                        ...
                        @empty
                        <div class="col-12 text-muted">No crypto asset activity yet.</div>
                        @endforelse
                    </div>
                </div>
            </div>
        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" id="btc_search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Crypto History..." />
                </div>
            </div>
