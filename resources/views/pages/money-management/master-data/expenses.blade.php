<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('money-management.master-data.expenses') }}
    @endsection
        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" id="expenses_search"
                        class="form-control form-control-solid w-250px ps-12" placeholder="Search Expenses..." />
                </div>
            </div>
            <div class="card-toolbar">
                <button type="button" class="btn btn-primary" id="btn_add_category">
                    <i class="ki-duotone ki-plus fs-2"></i> Add Expense Category
                </button>
            </div>
        </div>
        <div class="card-body">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="table_expenses">
                <thead>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bold" id="modal_category_title">Add Expense Category</h2>
                ...
                <form id="form_category" class="form">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Expense Name" name="name" id="cat_name" required />
                        </div>
                        <div class="fv-row mb-7">
    ...
    <script>
        $(document).ready(function() {
            let table = $('#table_expenses').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('money-management.master-data.expenses.datatable') }}",
                columns: [
            ...
            $('#expenses_search').keyup(function(){
            ...
            $('#btn_add_category').click(function() {
                ...
                $('#cat_id').val('');
                $('#modal_category_title').text('Add Expense Category');
            ...
            $(document).on('click', '.edit-category-btn', function() {
                ...
                $('#modal_category_title').text('Edit Expense Category');
                $('#modal_category').modal('show');
            });
            ...
            $(document).on('click', '.delete-category-btn', function() {
                let id = $(this).data('id');
                Swal.fire({
                    text: "Are you sure you want to delete this expense category?",
                    icon: "warning",
