        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bold" id="modalTitle">Add Permission</h2>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form id="kt_modal_permission_form" class="form" action="#">
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_permission_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_permission_header" data-kt-scroll-wrappers="#kt_modal_permission_scroll" data-kt-scroll-offset="300px">
                            <div class="fv-row mb-7">
                                <label class="required fw-semibold fs-6 mb-2">Permission Name</label>
                                <input type="text" name="name" id="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Permission Name" />
                            </div>
                            <div class="fv-row mb-7">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#kt_table_permissions').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('administrator.permissions.datatable') }}",
                columns: [
            ...
            $('#kt_modal_permission_form').on('submit', function(e) {
                ...
                var url = id ? "{{ url('administrator/permissions/update') }}/" + id : "{{ route('administrator.permissions.store') }}";
            ...
            $(document).on('click', '.edit-btn', function() {
                var id = $(this).data('id');
                $.get("{{ url('administrator/permissions/edit') }}/" + id, function(data) {
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ url('administrator/permissions/destroy') }}/" + id,
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}'
                            },
