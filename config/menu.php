        ...
        [
            ...
            'children' => [
                [
                    ...
                    'permission' => ['money-management.settings.category-expenses'],
                    'permissionType' => 'gate',
                    'icon' => 'ki',
                ...
                [
                    ...
                    'permission' => ['money-management.settings.category-income'],
                    'permissionType' => 'gate',
                    'icon' => 'ki',
                ...
                [
                    ...
                    'permission' => ['money-management.settings.investment'],
                    'permissionType' => 'gate',
                    'icon' => 'ki',
                    'iconName' => 'chart-line-up',
                ],
                [
                    ...
                    'permission' => ['money-management.settings.payroll'],
                    'permissionType' => 'gate',
                    'icon' => 'ki',
                    'iconName' => 'setting-2',
                ]
